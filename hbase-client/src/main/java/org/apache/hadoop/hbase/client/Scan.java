...
public class Scan extends Query {                 //scan扫描的参数类
  ...
  private Map<byte [], NavigableSet<byte []>> familyMap =
    new TreeMap<byte [], NavigableSet<byte []>>(Bytes.BYTES_COMPARATOR);  //family和qualifier的映射
   ...
   */
  private boolean small = false;        //small scan相关
