...
public abstract class QuotaSettings {         //这是一个处理与QuotaSettings相关的类
   ...
   */
  public static SetQuotaRequest buildSetQuotaRequestProto(final QuotaSettings settings) {    //序列化一个quota settings并通过PB发送到master
  ...
  protected String ownerToString() {              //将owner信息构建成String,注意StringBuilder在这里的用法
