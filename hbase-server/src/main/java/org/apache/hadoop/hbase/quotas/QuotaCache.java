...
public class QuotaCache implements Stoppable {
  ...
  public void start() throws IOException {
    ...
    rsServices.getChoreService().scheduleChore(refreshChore);     //启动refreshChore线程
  }
  ...
  private class QuotaRefresherChore extends ScheduledChore {      //周期地执行Quota上的更新
