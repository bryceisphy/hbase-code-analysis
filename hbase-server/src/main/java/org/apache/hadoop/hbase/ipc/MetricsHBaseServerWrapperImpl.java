...
public class MetricsHBaseServerWrapperImpl implements MetricsHBaseServerWrapper {   //wrapper这个类用于监控数据的读取
  ...
  public int getGeneralQueueLength() {
    ...
    return server.getScheduler().getGeneralQueueLength();   //wrapper先通过getScheduler()获得Rpc实例,然后获得统计数据
  }
