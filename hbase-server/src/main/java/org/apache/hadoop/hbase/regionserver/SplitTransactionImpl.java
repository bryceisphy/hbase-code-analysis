...
public class SplitTransactionImpl implements SplitTransaction {               //region split相关的实现
  ...
  private Pair<Integer, Integer> splitStoreFiles(
    ...
    // Default max #threads to use is the smaller of table's configured number of blocking store    解释见HBase－13959
