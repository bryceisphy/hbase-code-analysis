...
public class MetricsMasterFilesystemSourceImpl extends BaseSourceImpl implements MetricsMasterFileSystemSource {
  ...
  private MutableHistogram splitSizeHisto;        //split的size分布
  private MutableHistogram splitTimeHisto;        //split的时间分布
  private MutableHistogram metaSplitTimeHisto;    //metaregion split的size分布
  private MutableHistogram metaSplitSizeHisto;    //metaregion split的时间分布
