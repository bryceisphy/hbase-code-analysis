...
public class MetricsRegionServerSourceImpl
  ...
  private final MetricHistogram scanNextHisto;              //这些统计量以histogram形式记录

  private final MutableCounterLong slowPut;                 //慢写
  private final MutableCounterLong slowDelete;              //慢删
  private final MutableCounterLong slowGet;                 //慢查
  ...
  private final MutableCounterLong splitSuccess;            //这些统计量以counter形式记录
   ...
   */
  @Override
  public void getMetrics(MetricsCollector metricsCollector, boolean all) {          //执行getMetrics()去拉取MetricsRegionServerWrapper类中的统计信息
